    ...
    namespace CSharp_course_Lesson_and_DZ_7
    {
        class Program
        {
            static void Main(string[] args)
            {
                ...
                var v = CreateTestClassInstance(2, 33, "HONEY", 5, new char[] { '4', '3', '8', '2' }, new char[] { 'M', 'E', 'D', 'H' });
            ...
            {
                var customNameAttribute = Attribute.GetCustomAttribute(property, typeof(CustomNameAttribute)) as CustomNameAttribute;
